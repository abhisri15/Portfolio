      ...
      <div className="space-y-4">
        <div className="space-y-2">
          <div className="flex items-center space-x-2">
            ...
            <span className="text-xs text-gray-600 dark:text-gray-400 font-medium">Available for opportunities</span>
          </div>
          ...
          <div className="text-lg md:text-xl text-gray-600 dark:text-gray-300 h-6">
            I'm a{' '}
        ...
        <div className="flex space-x-2">
          <a
            ...
            className="p-2 bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-400 rounded-lg hover:bg-accent-500 hover:text-white transition-colors duration-100"
          >
      ...
      <div className="relative">
        <div className="relative">
          ...
          <div className="relative mx-auto w-64 h-64 mb-4">
            <div className="absolute inset-0 bg-gradient-to-br from-accent-500/20 to-purple-500/20 rounded-2xl blur-lg"></div>
            <div className="relative w-full h-full bg-gradient-to-br from-accent-500 to-accent-600 rounded-2xl p-1 shadow-lg">
            ...
            {/* Floating Elements */}
            <div className="absolute -top-1 -right-1 w-4 h-4 bg-gradient-to-br from-pink-500 to-purple-500 rounded-full"></div>
            <div className="absolute -bottom-1 -left-1 w-3 h-3 bg-gradient-to-br from-blue-500 to-cyan-500 rounded-full"></div>
          </div>
            ...
            {skills.map((skill, index) => {
              ...
              return (
                <div
                  ...
                  className="relative"
                >
                  <div className="p-3 bg-white/50 dark:bg-gray-800/50 backdrop-blur-sm rounded-lg border border-gray-200/50 dark:border-gray-700/50">
                    <div className={`w-6 h-6 bg-gradient-to-br ${skill.color} rounded-md flex items-center justify-center mb-1`}>
